...
class Geometry(ModuleMixin, _GeometryBase):
    ...
    def write(self, fileobj, index_lookup=None):
        ...
        Args:
            ...
            index_lookup (dict(:obj:`_GeometryBase <pypenelopetools.pengeom.base._GeometryBase>`, int), optional): 
        ...
        Returns:
            dict(:obj:`_GeometryBase <pypenelopetools.pengeom.base._GeometryBase>`, int): lookup table
        """
        if not index_lookup:

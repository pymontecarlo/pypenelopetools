...
import pypenelopetools.penmain.keywords as penelope_keywords
import pypenelopetools.penmain.separators as penelope_separators
...
class PenmainInput(PenelopeInput):
    ...
    def __init__(self):
        ...
        self.SBOX = penelope_keywords.SBOX()
        self.SBODY = penelope_keywords.SBODY()
        self.SCONE = penelope_keywords.SCONE()
        self.SRECTA = penelope_keywords.SRECTA()

        # Input phase-space file
        self.IPSFN = penelope_keywords.IPSFN()
        self.IPSPLI = penelope_keywords.IPSPLI()
        self.WGTWIN = penelope_keywords.WGTWIN()
        self.EPMAX = penelope_keywords.EPMAX()
        ...
        self.PARINP = penelope_keywords.PARINP()
        ...
        # Impact detectors
        self.impact_detectors = penelope_keywords.ImpactDetectors()

        # Energy-deposition detectors
        self.energy_deposition_detectors = penelope_keywords.EnergyDepositionDetectors()
        ...
        self.GRIDR = penelope_keywords.GRIDR()
    ...
    def get_keywords(self):
        return [self.TITLE,
                ...
                penelope_separators.DOT,
                penelope_separators.INPUT_PHASE_SPACE_FILE,
                ...
                penelope_separators.DOT,
                penelope_separators.IMPACT_DETECTORS,
                ...
                penelope_separators.DOT,
                penelope_separators.ABSORBED_DOSE_DISTRIBUTION,
